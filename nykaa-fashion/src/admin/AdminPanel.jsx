...
const AdminPanel = ({ onClose }) => {
  const { products, orders, addProduct, deleteProduct, updateProduct } =
    useApp();
      ...
      <div className="admin-panel">
        ...
        <div className="admin-header">
          <div className="admin-title">
            ...
            <div>
              <h2>Admin Panel</h2>
              <p>Tecygig Fashion Management</p>
            </div>
          </div>
                ...
                <div className="dash-quick">
                  ...
                  <div className="quick-list">
                    <div className="quick-item">
                      ...
                      <span className="quick-val red">
                        {products.filter((p) => p.stock < 10).length} items
                      </span>
                    </div>
                    <div className="quick-item">
                      <span>Processing Orders</span>
                      <span className="quick-val orange">
                        {orders.filter((o) => o.status === "Processing").length}
                      </span>
                    </div>
                    <div className="quick-item">
                      <span>Shipped Orders</span>
                      <span className="quick-val blue">
                    ...
                    <tr key={p.id}>
                      {editId === p.id ? (
                        ...
                        <>
                          ...
                          <td>
                            <span
                              className={`stock-badge${p.stock < 10 ? " low" : ""}`}
                            >
                              {p.stock}
                            </span>
                          </td>
                          <td>
                            <span className="disc-tag">{p.discount}%</span>
                          </td>
                          <td className="action-btns">
                            <button
                              className="btn-edit"
            ...
            <div className="add-form">
              ...
              <div className="form-preview">
                ...
                >
                  ...
                  <div>
                    <strong>{form.brand || "Brand"}</strong> —{" "}
